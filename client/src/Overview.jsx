...
import { ProductStyleContext } from './contexts/ProductStyleContext.jsx';
// params: product obj, all_styles arr, ratings arr
// { product, styles, stars }

const Overview = () => {
  // get new style by id
  const { product, styles } = useContext(ProductContext);
  // const { styles } = useContext(ProductStyleContext);

  // console.log(product);
  // console.log(styles);
  // styles.results.filter((x) => x.style_id === ID)[0];
